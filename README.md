...
Currently only tested well with Chrome (V8). Issues/PRs for more support are encouraged.

## Roadmap

- Whitelist which URLs are allowed to be fetched.
